...
const Landing = () => {
    ...
    useEffect(() => {
        ...
        async function fetchDocuments() {
            try {
                const response = await axios.get(`http://localhost:8080/documents/${userId}`);
            ...
            <div className='doc_section'>
                ...
                <div className='create-doc'>
                    ...
                    <div>
                        ...
                        <span>
                            <Link to={`/documents/${userId}/${docName}/${uuidV4()}`}>
                        ...
                        <span>
                            <Link to={`/documents/${userId}/${docName}/${uuidV4()}/room`}>
                                <button type='button' className='docCreateBtn'>
                                    Create Room &#8594;
                                </button>
                            </Link>
                    ...
                    >
                        {documents.map(doc => (
                            <SwiperSlide key={doc._id}>
                                ...
                                <Link to={`/documents/${userId}/${doc.name}/${doc._id}`}>
